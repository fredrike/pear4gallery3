...
<div id="detailView" onmousemove="showHoverView();">
	...
	<div class="content">
		...
		<div id="hoverView" class="" onmouseover="pear.hovering=true;" onmouseout="pear.hovering=false;">
			<div id="hoverViewMenu">
				<div id="download_detail" title="Download this photo" class="download_detail" onclick="document.location=slideshowImages[pear.currentImg][5]"> </div>
